...
\begin{figure}[hbt]
    %\hspace{-20pt}
    \subfigure{\includegraphics[width=0.20\textwidth]{abb/drohnen/P4RTK}}
    \hspace{-20pt}
    \subfigure{\includegraphics[width=0.52\textwidth]{abb/drohnen/trinity-f9}}
        \hspace{-30pt}
    \subfigure{\includegraphics[width=0.35\textwidth]{abb/drohnen/wingtraone}}
     \hspace{-20pt}
\caption[DJI Phantom 4 Quadrocopter, Trinity F9 und WintraOne VTOL-Drohnen]{\small v.l.n.r: DJI Phantom 4 Quadrocopter, Trinity F9 und WintraOne VTOL-Drohnen}
     \hspace{-40pt}
  \label{fig:drohnen}
\end{figure}
