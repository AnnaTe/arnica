...
\nomenclature{GUI}{Grafische Benutzeroberfläche}
\nomenclature{CC}{Connected Components}
\nomenclature{subsp.}{Subspezies oder Unterart}
\nomenclature{PyPI}{Python Package Index}
\nomenclature{GNU GPLv3}{GNU General Public License Version 3}
